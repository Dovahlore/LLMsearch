...
def clear_history():
    ...
    yield saved_history
def chat_with_model(user_input, chat_history, internet, max_history=20):
    global conversation_history,saved_history
...
with gr.Blocks() as demo:
    ...
    gr.HTML(
        '<a style="background-color: #0077b6; color: #fff; padding: 10px; border-radius: 5px; text-decoration: none;"'
        ' href="http://www.dovahwall.cn:8034" target="_blank"><button>Chat with Deepseek</button></a>')
...
demo.launch(server_name="0.0.0.0", server_port=8033)
